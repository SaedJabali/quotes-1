...
//   Connections urlConnection = new Connections();
    ...
    public static void readJsonFile() throws IOException {
        ...
        BufferedReader reader = Files.newBufferedReader(Paths.get("./src/main/resources/recentquotes.json"));
//
//
...
//            System.out.println("the data has been read :  " + data);
            ...
            String any = gson.toJson(quoteee.getQuote());
            QuotesData comment = gson.fromJson(any, QuotesData.class);
//            System.out.println("all quotes : " + quoteee);
            System.out.println("Quote : " + comment.getBody());
        }
    }
